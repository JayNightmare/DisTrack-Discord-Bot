...
module.exports = {
        ...
        .addStringOption((option) =>
            option
                ...
                .addChoices(
                    {
                        name: "Showcase",
                        value: "https://distrack.nexusgit.info/showcase",
                    },
                    {
                        name: "Contact",
                        value: "https://distrack.nexusgit.info/contact",
                    },
                    {
                        name: "Download",
                        value: "https://distrack.nexusgit.info/temp",
                    },
    ...
    async execute(interaction) {
        try {
            ...
            const botAvatar = interaction.client.user.avatarURL({
                size: 1024,
                dynamic: true,
            }); // Fetches the bot's avatar in high resolution
            ...
            const selectedSection =
                ...
                "https://distrack.nexusgit.info";

            if (selectedSection === "https://distrack.nexusgit.info/showcase") {
                section = "Showcase";
                embed.addFields({
                    name: section,
                ...
                selectedSection === "https://distrack.nexusgit.info/contact"
            ) {
                section = "Contact";
                embed.addFields({
                    name: section,
                ...
                selectedSection === "https://distrack.nexusgit.info/temp"
            ) {
                section = "Download";
                embed.addFields({
                    name: section,
                ...
                const bot =
                    "https://github.com/JayNightmare/DisTrack-Discord-Bot";
                const endpoint =
                    "https://github.com/JayNightmare/VSCode-Endpoint-Server-Deployment";
                const website =
